    ...
    <div className="flex min-h-screen w-full font-sans" style={{ background: '#EEF1EC' }}>
      ...
      <aside className="w-72 shrink-0 p-6 flex flex-col gap-7" style={{ background: '#1B2A41' }}>
        ...
        <div className="mt-auto pt-5 border-t text-[11px] font-sans leading-relaxed" style={{ borderColor: '#33425C', color: '#7A8699' }}>
          ...
          A program is flagged when its 5-yr average enrollment or graduate count is &le;10, or falls in the bottom 10% of whatever's currently in view. The Winter window and graduation window both roll forward automatically as new data is added.
          <br /><br />
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: 'Flagged — enrollment', value: stats.enrFlagged, color: '#3F6B52' },
            { label: 'Flagged — graduation', value: stats.gradFlagged, color: '#3F6B52' },
          ].map((s, i) => (
